...
import tokenauth from './pages/authentication/sign-in/tokenauth';
import PrivateRoute from './pages/authentication/PrivateRoute';

const App = () => {

// tokenauth.post('http://localhost:3001/authUser').catch((error) => {
//       console.log("Error in token auth: " + error);
//     });
    ...
    <IntlProvider locale="en" messages={locales.en}>
      <CustomProvider locale={enGB}>
        <Routes>
          ...
          <Route path="/" element={<><Frame navs={appNavs} /> <PrivateRoute /></>}>
